...
import AdministrationConent from '@/components/AdministrationConent';
...
const Dashboard = () => {
  ...
  return (
    <div className="flex min-h-screen">
      {/* Sidebar */}
      <div className={`bg-gray-800 text-gray-50 ${showSidebar ? 'block' : 'hidden'} sm:block md:block`}>
        {/* Sidebar content */}
        <div className="flex flex-col h-full">
          ...
          <Sidebar toggleDetails={()=>{}} toggleHome={toggleHome} toggleAdministration={toggleAdministration} />
        </div>
      </div>
      <div className={`bg-gray-800  text-gray-50 ${showSidebar ? 'hidden' : 'block'} sm:hidden md:hidden`}>
        {/* Sidebar content */}
      ...
      <div className="flex-1 bg-gray-100">
		...
		{showDetails && <HomeContents/>}
		{showHome && <HomeContents/>}
		{showAdministration && <AdministrationConent/>}
      </div>
    </div>
  );
};
