...
export const columns: ColumnDef<MealDetailsTypes>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => (
      <div className="text-center font-medium">
        {row.getValue("sharifLunch")}
      </div>
    ),
  },
  {
    accessorKey: "zahidLunch",
    header: ({ column }) => {
      return (
        <div className="flex justify-center items-center">
          <Button
    ...
    cell: ({ row }) => (
      <div className="text-center font-medium">
        {row.getValue("zahidLunch")}
      </div>
    ),
  },
  {
    accessorKey: "yasinLunch",
    header: ({ column }) => {
      return (
        <div className="flex justify-center items-center">
          <Button
    ...
    cell: ({ row }) => (
      <div className="text-center font-medium">
        {row.getValue("yasinLunch")}
      </div>
    ),
  },
  {
    accessorKey: "tamjidLunch",
    header: ({ column }) => {
      return (
        <div className="flex justify-center items-center">
          <Button
    ...
    cell: ({ row }) => (
      <div className="text-center font-medium">{row.getValue("tamjidLunch")}</div>
    ),
  },
  {
    accessorKey: "towhidLunch",
    header: ({ column }) => {
      return (
        <div className="flex justify-center items-center">
          <Button
